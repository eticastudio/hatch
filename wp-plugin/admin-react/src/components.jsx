...
export const HxRow = ({ label, desc, children, last }) => (
	...
	>
		<div style={{ flex: 1 }}>
			<div style={{ fontSize: 14, fontWeight: 500, color: 'var(--hx-fg)', lineHeight: 1.4 }}>{label}</div>
			{desc && (
				<div style={{ fontSize: 13, color: 'var(--hx-subtle)', marginTop: 2, lineHeight: 1.5 }}>{desc}</div>
			)}
		</div>
...
export const HxHead = ({ iconChildren, iconColor = 'var(--hx-muted)', title, desc, mb = 20, action }) => (
	<div style={{ display: 'flex', gap: 14, alignItems: 'flex-start', marginBottom: mb }}>
		...
		<div style={{ flex: 1, paddingTop: 1 }}>
			<div style={{ fontSize: 15, fontWeight: 600, color: 'var(--hx-fg)', lineHeight: 1.3 }}>{title}</div>
			{desc && (
				<div style={{ fontSize: 13, color: 'var(--hx-subtle)', marginTop: 3, lineHeight: 1.55 }}>{desc}</div>
			)}
		</div>
		{action}
	</div>
