...
// V0.8 — Health widget on /wp-admin (real metrics, no vibe-coded statuses).
...
final class Hatch {
	...
	private function __construct() {
		...
		// V0.8 — Dashboard health widget (admin only, capability-gated inside).
		if ( is_admin() ) {
			Hatch_Health_Widget::instance();
		}
